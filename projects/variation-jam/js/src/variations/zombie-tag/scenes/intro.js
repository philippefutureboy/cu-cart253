...
/**
 * ZombieTag.IntroScene
 *
 * Displays game rules for a short period of time.
 * Transitions to ZombieTag.PlayScene.
 *
 */
export default class IntroScene extends BaseScene {
  static key = "zombie-tag-game.intro";
  static label = "Zombie Tag Game: Intro Scene";
  ...
  setup(p5) {
    ...
    return [
      new SceneRequest("Zombie-tag-game.lose", "preload"),
      new SceneRequest("Zombie-tag-game.win", "preload"),
    ];
  }
  ...
  draw(p5) {
    ...
    p5.push();
    {
      ...
      p5.text("AAARGGHHH      !", p5.width / 2, p5.height / 2);
      p5.fill(theme.colors.tag);
      p5.text("ZOMBIES", p5.width / 2 + 132, p5.height / 2);
      p5.fill(theme.colors.textDefault);
      p5.textSize(typo.h1Subtitle.size);
      p5.text(
        "run away, dont get bitten!",
        p5.width / 2,
    ...
    if (secondsLeft === 0) {
      ...
      return new SceneRequest("zombie-tag-game.play");
    }
  }
