...
/**
 * RealisticTag.BailedOutScene
 *
 * Displays my disappointment if you chose not to play the game.
 * Transitions to main menu.
 *
 */
export default class BailedOutScene extends BaseScene {
  static key = "realistic-tag-game.bailed-out";
  static label = "Realistic Tag Game: Bailed Out Scene";
  ...
  /**
   * Draws the disappointment text.
   * Requests transition to menu once duration has been elapsed.
   *
   * @param {import('p5')} p5
   */
  draw(p5) {
    ...
    p5.push();
    {
      ...
      p5.text("Man, youre no fun :/", p5.width / 2, p5.height / 2);
    }
    p5.pop();
