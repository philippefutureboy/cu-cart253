 ...
 *
 * Imported from mod-jam. 100% manually implemented.
 */
...
export class CoordinatesBox {
   ...
   */
  inBox(point) {
    const xInBox = this.xMin <= point.x && this.xMax >= point.x;
    const yInBox = this.yMin <= point.y && this.yMax >= point.y;
